...
<script>
	function validate() {
		...
		if (custid == null || custid == "") {
			...
			return false;
		} /*  else if (acctype == null || acctype == "") {
			alert('Account type cannot be blank');
			return false; */ 
		} else if (initdeposit == null || initdeposit == "") {
			alert('Initial Deposit cannot be blank');
			return false;
		} else if (minbal == null || minbal == "") {
			alert("Minimum Balance can't be blank");
			return false;
		} else if (overdraft == null || overdraft == "") {
...
<body>
	...
	<form name="form" action="AccountServlet" method="post"
		...
		<table align="center">
			...
			<tr>
				<td>Account Type</td>
				<td><input type="radio" name="acctype" value="saving" checked>Saving
					Account</td>
				<td><input type="radio" name="acctype" value="current">Current
					Account</td>
			...
			<tr>
				<td></td>
				<td><input type="submit" value="Open Account"><br>
